...
<template>
    ...
    <Link :href="route('inertia.show', { id: 50 })">ルートパラメータのテストです
    </Link>
    <div class="mb-8"></div>
    <!-- v-modelにref変数を定義する事で、入力した値が連動して変数に代入されます -->
    ...
    <!-- asでbuttonを定義 DB保存したい為、methodはpost
    ：dataでControllerのstoreメソッドに渡したい変数を入力 -->
